...
We utilized as our orchestration tool \hyperref[sec:docker-compose]{Docker Compose}, allowing us to apply and deploy the same setup as configured on various machines with minimal processing.
