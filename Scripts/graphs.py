...
for filename in filenames:
    ...
    csv_files = [
        os.path.join("Results", "Rodrigo", "res_desktop", "csv", filename),  # 1
        os.path.join("Results", "Silva", "csv", filename),  # 2
        os.path.join("Results", "Ze", "csv", filename),  # 3
        os.path.join("Results", "Rodrigo", "res_macos", "csv", filename),  # 4
    ]
    ...
    for file, label in zip(csv_files, labels):
        ...
        x_values = [
            i * 10 / 60 for i in range(len(tpm_values))
        ]  # Scale 0-60 points to 0-10
...
paths = [
    os.path.join("Results", "Rodrigo", "res_desktop", "csv", "hammerdb_summary.csv"),
    os.path.join("Results", "Silva", "csv", "hammerdb_summary.csv"),
    os.path.join("Results", "Ze", "csv", "hammerdb_summary.csv"),
    os.path.join("Results", "Rodrigo", "res_macos", "csv", "hammerdb_summary.csv"),
]
